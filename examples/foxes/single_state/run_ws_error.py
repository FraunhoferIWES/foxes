...
if __name__ == "__main__":
    ...
    # manually add wind speed error for debugging
    #args.w_e = 0.06
    ...
    states_lower = foxes.input.states.SingleStateStates(
        ws=args.ws-(args.w_e*args.ws), wd=args.wd, ti=args.ti, rho=args.rho
    )
    ...
    print(f"Wind speed error is {args.w_e}")
    ...
    # print(
    #     fr_lower[[FV.X, FV.WD, FV.AMB_REWS, FV.REWS, FV.AMB_TI, FV.TI, FV.AMB_P, FV.P, FV.CT]]
    # )
    print(
        fr[[FV.X, FV.WD, FV.AMB_REWS, FV.REWS, FV.AMB_TI, FV.TI, FV.AMB_P, FV.P, FV.CT]]
    )
    # print(
    #     fr_upper[[FV.X, FV.WD, FV.AMB_REWS, FV.REWS, FV.AMB_TI, FV.TI, FV.AMB_P, FV.P, FV.CT]]
    # )
    ...
    print(f"\nStandard error in power calculated as {std_err_mean*100:.1f}% per turbine")
