...
if __name__ == "__main__":
    ...
    parser.add_argument("-w", "--wake", help="The wind wake model", default="Bastankhah_rotor")
    parser.add_argument("-s", "--superp", help="The wind wake superposition model", default="wind_linear")
