...
class ModelBook:
    ...
    def __init__(self, Pct_file=None):
        ...
        self.wake_frames["seq_dyn_wakes"] = fm.wake_frames.sequential.SeqDynamicWakes()
        for s, t in dtlist:
            self.wake_frames[f"seq_dyn_wakes_{s}"] = fm.wake_frames.sequential.SeqDynamicWakes(dt_min=t)
