...
def _read_turbulence(turbulence_model, superposition, induction, algo_dict, 
...
def _read_analysis(wio_ana, algo_dict, verbosity):
    ...
    ka, kb, amb_ti = _read_wind_deficit(wind_deficit, superposition, induction, algo_dict, verbosity)

    # turbulence model:
    turbulence_model = Dict(wio_ana["turbulence_model"], name="turbulence_model")
    _read_turbulence(turbulence_model, superposition, induction, algo_dict, ka, kb, amb_ti, verbosity)
